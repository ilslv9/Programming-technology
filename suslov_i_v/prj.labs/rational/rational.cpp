#include "rational.h"																								//îïèñàíèå bool êëàññà Rational
...
bool Rational::operator!=(const Rational& rhs) {
	return !(operator==(rhs));
																									...
																									//îïèñàíèå îïåðàöèé è ôóíêöèé êëàññà Rational
...
void Rational::normalize() {
	...
	if (den < 0) {
		...
		den *= -1;
																									...
																									//îïèñàíèå êîíñòðóêòîðîâ êëàññà Rational
...
Rational::Rational(const int numarator, const int denumenator)
	...
	, den(denumenator) {
																									...
																									//îïèñàíèå îïåðàöèé ñ òèïîì Rational
